        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold leading-none sm:text-4xl">
              ...
              <span className="text-orange-600">{props.subTitle}</span>
            </h2>
            ...
            <Link
              to={props.visit}
              className="inline-block py-3 px-4 text-white bg-orange-500 hover:bg-orange-600 rounded-md no-underline"
            >
              {props.btnAbout}
            </Link>
          </div>
