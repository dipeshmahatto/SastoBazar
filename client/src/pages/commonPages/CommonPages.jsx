...
const CommonPages =(props)=> {
  return (
    <>
    <div
        className="font-poppins px-4 py-16 mx-auto sm:max-w-xl md:max-w-full 
        lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20"
      >
        <div className="grid gab-8 lg:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-3xl font-bold leading-none sm:text-4xl">
          ...
          <div className="flex justify-center">
            <img
              src={props.imgAbout}
              alt="SastoBazar"
              className="w-full h-full max-w-md object-contain amimate-moveUpDown"
            />
          </div>
        </div>
      </div>
