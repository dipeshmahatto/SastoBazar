    ...
    <>
      <header className="font-poppins flex items-center justify-evenly p-4 bg-white-200">
        ...
        <div className="flex items-center ml-2">
          ...
          <div className="ml-4">
            <NavLink to="/sastobazar-cart" className="relative">
              <FiShoppingCart className="h-6 w-6 text-gray-700" />
              <span className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-orange-500 rounded-3xl">
                0
              </span>
            </NavLink>
          </div>
